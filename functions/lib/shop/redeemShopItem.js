...
exports.redeemShopItem = void 0;
const admin = __importStar(require("firebase-admin"));
const functions = __importStar(require("firebase-functions/v1"));
exports.redeemShopItem = functions
    ...
    const itemId = String((_a = data === null || data === void 0 ? void 0 : data.itemId) !== null && _a !== void 0 ? _a : "").trim();
    if (!itemId) {
    ...
    await db.runTransaction(async (tx) => {
        ...
        const coinPrice = Math.max(0, Number((_a = item.price) !== null && _a !== void 0 ? _a : 0));
        const goldPrice = Math.max(0, Number((_b = item.goldPrice) !== null && _b !== void 0 ? _b : 0));
        if (useGold) {
            const currentGold = Number((_c = user.goldCoins) !== null && _c !== void 0 ? _c : 0);
            ...
            const currentCoins = Number((_d = user.coins) !== null && _d !== void 0 ? _d : 0);
        ...
        tx.set(redemptionRef, {
            ...
            itemId,
            itemName: item.name,
            itemEmoji: (_e = item.emoji) !== null && _e !== void 0 ? _e : "[gift]",
...
//# sourceMappingURL=redeemShopItem.js.map